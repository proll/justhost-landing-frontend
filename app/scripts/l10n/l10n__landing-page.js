...
jhst.l10n.landing_page = {
	...
	'section1-p': {
		en: 'Justhost — it is a platform for creating price tags<br/>and getting payments for your digital content or real<br/>goods and servicies',
		ru: 'Justhost — это сервис для создания виртуальных ценников<br/>и приема платежей за ваш контент или реальные<br/>товары и услуги'
	},
	...
	'Start': {
		en: 'Start Justhost',
		ru: 'Начать продавать c Justhost'
	},
	...
	'How does Justhost work': {
		en: 'How payments can be received with Justhost',
		ru: 'Как принимать оплату с Justhost'
	},
	...
	// 'section2-2-2-p': {
	// 	en: 'Your customer is around. Give your readers or fans a possibility to thank You.<br/>To sell your product is as easy as to share a link. Turn any object, any site and any message to a showcase of your shop!<br/>Integration Justhost and your site is one line of code! For real!',
	// 	ru: 'Ваш клиент рядом! Дайте возможность поблагодарить вас читателям вашего блога или фанатам вашего творчества.<br/>Продать ваш продукт это так же просто как расшарить ссылку - продавайте там где уже есть ваша целевая аудитория. Превратите любой объект, любой сайт, любое сообщение в витрину вашего магазина!<br/>Интеграция Justhost и вашего сайта? Одна строчка кода, реально!'
	// },
	...
	'section4-3-1-p': {
		en: 'All Justhost service absolutely free till the middle of 2014',
		ru: 'Все сервисы Justhost абсолютно бесплатны до середины 2014'
	},
}