...
module.exports = function(grunt) {
	...
	grunt.initConfig({
		...
		less: {
			all: {
				src: 'app/styles/less/jhst.less',
				dest: 'app/styles/css/jhst.css',
				options: {
					compress: true
				}
			}
		...
		cssmin: {
			dist: {
				files: {
					'<%= yeoman.dist %>/styles/css/jhst.css': [
						'.tmp/styles/{,*/}*.css',
						'<%= yeoman.app %>/styles/css/jhst.css'
					],
					'<%= yeoman.dist %>/styles/css/jhst_static.css': [
						'.tmp/styles/{,*/}*.css',
						'<%= yeoman.app %>/styles/css/jhst_static.css'
					]
				}
			}
		},
		...
		handlebars:{
			compile:{
				options:{
					wrapped:true,
					namespace:"jhst.Templates.ptemplates",
